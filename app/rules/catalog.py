...
KISA_2021_CATALOG: tuple[CatalogEntry, ...] = (
    ...
    _entry(1, 6, _INPUT_VALIDATION, "위험한 형식 파일 업로드", Severity.HIGH, _INITIAL_RULE_LANGUAGES, ImplementationStatus.PARTIAL, "kisa-2021-unrestricted-upload-python"),
    _entry(1, 7, _INPUT_VALIDATION, "신뢰되지 않는 URL 주소로 자동접속 연결"),
    _entry(1, 8, _INPUT_VALIDATION, "부적절한 XML 외부개체 참조", Severity.HIGH, _INITIAL_RULE_LANGUAGES, ImplementationStatus.PARTIAL, "kisa-2021-xxe-python"),
